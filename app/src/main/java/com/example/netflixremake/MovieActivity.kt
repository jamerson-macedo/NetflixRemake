...
import co.tiagoaguiar.netflixremake.MovieAdapter
import com.example.netflixremake.model.Category
import com.example.netflixremake.model.Movie
import com.example.netflixremake.model.MovieDetail
import com.example.netflixremake.util.ImageTask
...
class MovieActivity : AppCompatActivity(),MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        photo=findViewById(R.id.movie_img)
...
//        }
    ...
    override fun onResult(movieDetail: MovieDetail) {
        ...
        tvTitle.text = movieDetail.movie.cast
